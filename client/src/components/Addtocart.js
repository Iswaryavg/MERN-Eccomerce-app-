...
function Addtocart(props)
{
 ...
 const [showcartitems,setshowcartitems]=useState([props]);

 useEffect(() => {
 

setcartitems((props.addtocart.find(x=>x.id==props.match.params.id)))
...
const getcartdata=JSON.parse(data)
    setshowcartitems(getcartdata)
     ...
     <div className="cart-items">
         <div className="cart-row">
             <div className="cart-item cart-column">
                 ...
                 <span className="cart-item-title">{showcartitems.name}</span>
             </div>
